...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.paradox.zswebsite.domain.PageContent.class.getName());
            createCache(cm, com.paradox.zswebsite.domain.PageContent.class.getName() + ".media");
            createCache(cm, com.paradox.zswebsite.domain.PageContentMedia.class.getName());
