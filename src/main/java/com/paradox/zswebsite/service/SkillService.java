...
/**
 * Service Implementation for managing {@link com.paradox.zswebsite.domain.Skill}.
 */
@Service
@Transactional
public class SkillService {
    ...
    /**
     * Get all the skills without pagination.
     *
     * @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<SkillDTO> findAllUnpaginated() {
        log.debug("Request to get all Skills without pagination");
        // The default findAll() from JpaRepository returns all entities.
        // We then map them to DTOs.
