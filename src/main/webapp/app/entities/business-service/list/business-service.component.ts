...
export class BusinessServiceComponent implements OnInit {
  ...
  businessServices = signal<IBusinessService[]>([]);
  isLoading = false;
  ...
  protected readonly businessServiceService = inject(BusinessServiceService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IBusinessService): number => this.businessServiceService.getBusinessServiceIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.businessServices.set(dataFromBody);
  }
