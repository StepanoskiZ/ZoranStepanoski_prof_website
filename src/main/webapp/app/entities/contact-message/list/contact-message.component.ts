...
export class ContactMessageComponent implements OnInit {
  ...
  contactMessages = signal<IContactMessage[]>([]);
  isLoading = false;
  ...
  protected readonly contactMessageService = inject(ContactMessageService);
  ...
  trackId = (item: IContactMessage): number => this.contactMessageService.getContactMessageIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.contactMessages.set(dataFromBody);
  }
