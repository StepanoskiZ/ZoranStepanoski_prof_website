...
export class PageContentMediaComponent implements OnInit {
  pageContentMedias?: IPageContentMedia[];
  isLoading = false;
  ...
  trackId = (_index: number, item: IPageContentMedia): number => this.pageContentMediaService.getPageContentMediaIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.pageContentMedias = dataFromBody;
  }
