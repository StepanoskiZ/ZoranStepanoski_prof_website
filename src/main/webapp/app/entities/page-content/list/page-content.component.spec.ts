...
describe('PageContent Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'page-content', component: PageContentComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pageContents?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to pageContentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPageContentIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPageContentIdentifier).toHaveBeenCalledWith(entity);
