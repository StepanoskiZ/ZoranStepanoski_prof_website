...
export class PageContentComponent implements OnInit {
  ...
  pageContents = signal<IPageContent[]>([]);
  isLoading = false;
  ...
  protected readonly pageContentService = inject(PageContentService);
  ...
  trackId = (item: IPageContent): number => this.pageContentService.getPageContentIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.pageContents.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IPageContent[] | null): IPageContent[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.pageContentService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
