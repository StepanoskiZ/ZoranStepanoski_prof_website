...
export class VisitorLogComponent implements OnInit {
  ...
  visitorLogs = signal<IVisitorLog[]>([]);
  isLoading = false;
  ...
  protected readonly visitorLogService = inject(VisitorLogService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IVisitorLog): number => this.visitorLogService.getVisitorLogIdentifier(item);
  ...
  delete(visitorLog: IVisitorLog): void {
    const modalRef = this.modalService.open(VisitorLogDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.visitorLog = visitorLog;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.visitorLogs.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IVisitorLog[] | null): IVisitorLog[] {
    return data ?? [];
  }
