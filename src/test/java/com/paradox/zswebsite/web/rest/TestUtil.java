...
public final class TestUtil {
    ...
    // You don't need to add new methods if you have the generic one above.
    // However, if your TestUtil was generated with specific types, you would add them like this:
    /*
public static byte[] convertObjectToJsonBytes(BlogPostDTO blogPostDTO) throws IOException {
    // The implementation can just call the generic one
    return convertObjectToJsonBytes((Object) blogPostDTO);
}

public static byte[] convertObjectToJsonBytes(BlogPost blogPost) throws IOException {
    return convertObjectToJsonBytes((Object) blogPost);
}
// ... and so on for every other DTO and Domain class from the error list.
*/
}
